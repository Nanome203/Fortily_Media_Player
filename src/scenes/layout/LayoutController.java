...
public class LayoutController implements Initializable {
  ...
  public void initialize(URL arg0, ResourceBundle arg1) {
    try {
      ...
      String musicTable = "create table if not exists music(pathname text primary key);";
      String videoTable = "create table if not exists video(pathname text primary key);";
      ...
      statement.execute(musicTable);
      statement.execute(videoTable);
